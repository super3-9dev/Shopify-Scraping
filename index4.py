...
class ShopifyProductScraper:
    ...
    def scrape_product_links(self, url):
        ...
        selectors = ['a[class*="product-link"]']
    ...
    def scrape_product_details(self, product_url):
        ...
        try:
            ...
            # Extract title
            title_selectors = ['h1.product-title', '.product__title']
            ...
            images = []
            img_selector = '.lazy-image--backfill img'
...
def main():
    # Initialize scraper
    base_url = "https://gypphy-shop.com"
    category_url = "https://gypphy-shop.com/en/collections/fine-jewelry-en?page=1"
    scraper = ShopifyProductScraper(base_url)
    # Scrape products
    scraper.scrape_all_products(category_url)
    # Save to both Excel and CSV
    scraper.save_to_excel('gypphy_products.xlsx')
